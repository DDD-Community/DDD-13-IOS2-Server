...
- Read NFR requirements from `aidlc-docs/construction/internal/{unit-name}/nfr-requirements/`
...
### Step 4: Store Plan
- Save as `aidlc-docs/construction/internal/plans/{unit-name}-nfr-design-plan.md`
...
- Create `aidlc-docs/construction/internal/{unit-name}/nfr-design/nfr-design-patterns.md`
- Create `aidlc-docs/construction/internal/{unit-name}/nfr-design/logical-components.md`
