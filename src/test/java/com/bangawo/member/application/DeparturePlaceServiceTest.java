...
class DeparturePlaceServiceTest {
    ...
    void 첫_등록_시_isDefault_강제_true() {
        ...
        service.create(1L, "집", "서울시 강남구", 37.5, 127.0, false);
    ...
    void 최대_3개_초과_시_LIMIT_EXCEEDED_예외() {
        ...
        assertThatThrownBy(() -> service.create(1L, "집", "서울시", 37.5, 127.0, false))
    ...
    void isDefault_true_요청_시_기존_기본_해제() {
        ...
        service.create(1L, "회사", "서울시 중구", 37.5, 127.0, true);
    ...
    void 출발지_수정_성공() {
        ...
        service.update(1L, 10L, "회사", "신주소", 37.6, 127.1);
    ...
    void 타인_소유_출발지_수정_시_NOT_FOUND_예외() {
        ...
        assertThatThrownBy(() -> service.update(1L, 10L, "회사", "서울", 37.5, 127.0))
                .isInstanceOf(BusinessException.class)
                .satisfies(e -> assertThat(((BusinessException) e).getErrorCode())
